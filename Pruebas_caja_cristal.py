...
def calcular_descuento(cantidad_artículos):
    """
    Calcula el descuento a aplicar en función de la cantidad de artículos comprados.
    """
...
class PruebaCajaCristal(unittest.TestCase):
    ...
    def test_descuento_cero(self):
        """
        Prueba que se devuelve un descuento del 0% para una cantidad de artículos menor que 5.
        """
    ...
    def test_descuento_diez(self):
        """
        Prueba que se devuelve un descuento del 10% para una cantidad de artículos entre 5 y 9.
        """
    ...
    def test_descuento_veinte(self):
        """
        Prueba que se devuelve un descuento del 20% para una cantidad de artículos igual o mayor que 10.
        """
